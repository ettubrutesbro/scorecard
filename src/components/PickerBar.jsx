...
const Value = styled.div`
    position: absolute;
    opacity: ${props => props.invis? 0: 1};
    top: 15px;
    transition: ${props=> props.invis? 'opacity .25s, transform .25s' : ''};
    transform: ${props => props.invis? 'translateY(-100%)' : 'translateY(0)'};

`
const Prompt = styled.div`
    z-index: 3;
    position: absolute;
    transition: ${props => props.active? 'opacity .25s, transform .25s' : ''};
    transition-delay: ${props => props.active? '.1s': ''};
