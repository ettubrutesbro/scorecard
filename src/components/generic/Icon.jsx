...
const icons = {
    ...
    document: <g> <polygon points="25.7,29.8 8.3,29.8 8.3,8.2 16.6,8.2 16.6,8.9 9,8.9 9,29.1 25,29.1 25,17.2 25.7,17.2 "/>
        <polygon points="22.2,6.2 22.2,6.9 26.4,6.9 16.1,17.3 16.6,17.8 27,7.5 27,11.8 27.7,11.8 27.7,6.2 "/>
        <polygon points="25.8,29.8 8.4,29.9 8.2,8.2 16.6,8.2 16.6,8.9 9,9 9.1,29.1 25,29 25,17.2 25.7,17.2 "/>
    </g>,
    info: <g>
        <path d="M24.1,3.6c0,0.7-0.2,1.4-0.4,2c4.7,2.2,8,6.9,8,12.4c0,7.5-6.1,13.6-13.6,13.6S4.4,25.5,4.4,18
    ...
    <ellipse cx="18.1" cy="3.6" rx="2.2" ry="2.1"/>
    <path d="M19.6,23.8c0-1.7-0.1-3.8-0.1-5.3v-4.4l0.1-4.5l-0.5-0.3l-5.1,2v1.2l2.7,0.3c0.1,1.3,0.1,2.3,0.1,4.2v1.6
        c0,1.5,0,3.6-0.1,5.3l-2.5,0.5v1.2h2.5h2.9h2.3v-1.2L19.6,23.8z"/>
    </g>,
    strokefeedback: <g>
        <polygon points="28.5,7.5 7.5,7.5 7.5,23.2 11.8,23.2 11.8,29.5 18.1,23.2 28.5,23.2 "/>
        <line x1="18" y1="19.4" x2="18" y2="18.4"/>
        <line x1="18" y1="17.1" x2="18" y2="10.8"/>
    </g>
}
